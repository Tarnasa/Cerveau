...
/**
 * The settings manager for the Blobmaster2 game.
 */
export class Blobmaster2GameSettingsManager extends BaseClasses.GameSettings {
    /**
    ...
    public get schema() { // tslint:disable-line:typedef
        return this.makeSchema({
            ...
            // Blobmaster2 game specific settings
            bigBlobSpeed: {
     ...
     */
    public values!: SettingsFromSchema<Blobmaster2GameSettingsManager["schema"]>;
