...
import { IBaseBlobmaster2Player, IPlayerDropArgs } from "./";
import { AI } from "./ai";
 ...
 */
export class Player extends GameObject implements IBaseBlobmaster2Player {
    ...
    constructor(
        ...
        args: Readonly<IBaseBlobmaster2Player>,
