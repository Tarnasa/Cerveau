...
// around it.
import { BaseClasses, Blobmaster2Game, Blobmaster2GameObjectFactory,
       } from "./";
...
/**
 * Manages the game logic around the Blobmaster2 Game.
 ...
 * together.
 */
export class Blobmaster2GameManager extends BaseClasses.GameManager {
    /** Other strings (case insensitive) that can be used as an ID */
    public static get aliases(): string[] {
        return [
            // <<-- Creer-Merge: aliases -->>
            "MegaMinerAI-##-Blobmaster2",
            // <<-- /Creer-Merge: aliases -->>
        ];
    }

    /** The game this GameManager is managing */
    public readonly game!: Blobmaster2Game;

    /** The factory that must be used to initialize new game objects */
    public readonly create!: Blobmaster2GameObjectFactory;
