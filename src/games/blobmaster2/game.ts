...
import { Blobmaster2GameManager } from "./game-manager";
import { GameObject } from "./game-object";
import { Blobmaster2GameSettingsManager } from "./game-settings";
 ...
 * blobs to win.
 */
export class Blobmaster2Game extends BaseClasses.Game {
    /** The manager of this game, that controls everything around it */
    public readonly manager!: Blobmaster2GameManager;
     ...
     */
    constructor(
        protected settingsManager: Blobmaster2GameSettingsManager,
